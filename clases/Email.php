...
class Email {
    ...
    public function enviarConfirmacion(){
        ...
        $mail->setFrom('user@SecurityCompliance.com');
        $mail->addAddress('cuentas@SecurityCompliance.com', 'SecComp.com');
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->email . "</strong> Has creado tu cuenta en Security Compliance, solo debes confirmarla en el siguiente enlace.</p>";
