(function(){
    ...
    function mostrarFormulario(editar = false, tarea = {}){
        ...
        <form class="formulario nueva-tarea">
            ...
            <div class="campo">
                <label>Tarea</label>
                <input type="text" name="tarea" placeholder="${tarea.nombre ? 'Edita la Tarea' : 'Añadir al Proyecto Actual'}" id="tarea" value="${tarea.nombre ? tarea.nombre : ''}" />
            </div>
            <div class="opciones">
    ...
    //consultar al servidor para agregar nueva tarea
